      ...
      <div className="w-full max-w-md p-8">
        ...
        <div className="bg-secondary border border-slate-700 rounded-lg p-8">
          ...
          <button
            ...
            className="w-full mb-3 px-4 py-3 bg-slate-800 hover:bg-slate-700 border border-slate-600 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
          ...
          <button
            ...
            className="w-full px-4 py-3 bg-slate-800 hover:bg-slate-700 border border-slate-600 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
          ...
          <p className="text-xs text-slate-500 text-center mt-6">
            We'll use your GitHub or Google account to sign you in securely.
          </p>
        </div>
      </div>
    </div>
